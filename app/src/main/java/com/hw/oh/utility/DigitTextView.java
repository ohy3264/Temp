...
public class DigitTextView extends FrameLayout {
    ...
    public void resetValue(final int desiredValue){
        currentTextView.setText(String.format(Locale.getDefault(), "%02d", desiredValue));
    ...
    public void setValue(final int desiredValue) {
        ...
        if (oldValue > desiredValue) {
            nextTextView.setText(String.format(Locale.getDefault(), "%02d", oldValue-1));
            ...
            nextTextView.animate().translationY(0).setDuration(ANIMATION_DURATION).setListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(Animator animation) {
                    currentTextView.setText(String.format(Locale.getDefault(), "%02d", oldValue - 1));
